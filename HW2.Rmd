...
confint(glm_logit) [2,2]
confint(glm_probit) [2,2]
confint(glm_clog)[2,2]
...
data.frame(
    ...
    ci_lower = c(confint(glm_logit) [2,1], confint(glm_probit) [2,1],
                 confint(glm_clog)[2,1]),
    ci_upper = c(confint(glm_logit) [2,2], confint(glm_probit) [2,2],
                 confint(glm_clog)[2,2]),
